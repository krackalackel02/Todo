...
<h1>
				...
				<ul class="content-list">
					<li class="content-list-item"><span class="content-list-item-symbol">
						...
						</span > <span class="content-list-item-symbol"><span class="content-list-item-date">Due:</span><input type="date"/><span
								class="material-symbols-outlined content-list-item-marker"> delete </span></span></li>
